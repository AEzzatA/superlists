...
class NewVisitor(LiveServerTestCase):
	...
	def test_can_start_a_list_and_retrieve_it_later(self):
		...
		#And nwo the page lists "1: Buy peacock feathers" as an item in a
		#to-do list table
		...
		#Now a new user Fracies comes along to the site
		##We make a new browser session to make sure that no information
		##of Edith's is coming through from our cookies etc

		self.browser.quit()
		self.browser = webdriver.Firefox()

		#Fracies vists the home page, There is no sign of Edith's
		#list
		...
		#Fracies starts a new list by entering a new item.
